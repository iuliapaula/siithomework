...
public void testAddition() {
    Calculator calculator = new Calculator("2 mm + 10 mm");
    int result = calculator.calculateExpression();
...
public void multipleMeasureUnits() {
    Calculator calculator = new Calculator("1 km + 2 m + 3 dm + 4 cm + 5 mm");
    int result = calculator.calculateExpression();
...
@Test
    ...
    Calculator calculator = new Calculator("100 mm + 30 mm - 5 mm + 2 mm");
    int result = calculator.calculateExpression();
